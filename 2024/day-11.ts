...
function blink2(input: Record<number | string, number>): Record<number | string, number> {
...
function addStone(stoneCount: Record<number, number>, stoneNumber: number, count: number) {
